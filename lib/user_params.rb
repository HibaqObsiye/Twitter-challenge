...
class UserParams
  ...
  # end
   ...
   def invalid_params?
     invalid_email?  || name_contains_incorrect_characters? || username_contains_incorrect_characters? 
    #  || password_contains_incorrect_characters? || weak_password? || duplicate_username? || duplicate_email?
   end
end